...
// MintByAdmin is a paid mutator transaction binding the contract method 0xb9f9391f.
//
// Solidity: function mintByAdmin(bytes signature) returns(uint256 tokenId)
func (_Owldinal *OwldinalTransactor) MintByAdmin(opts *bind.TransactOpts, signature []byte) (*types.Transaction, error) {
	return _Owldinal.contract.Transact(opts, "mintByAdmin", signature)
}

// MintByAdmin is a paid mutator transaction binding the contract method 0xb9f9391f.
//
// Solidity: function mintByAdmin(bytes signature) returns(uint256 tokenId)
func (_Owldinal *OwldinalSession) MintByAdmin(signature []byte) (*types.Transaction, error) {
	return _Owldinal.Contract.MintByAdmin(&_Owldinal.TransactOpts, signature)
}

// MintByAdmin is a paid mutator transaction binding the contract method 0xb9f9391f.
//
// Solidity: function mintByAdmin(bytes signature) returns(uint256 tokenId)
func (_Owldinal *OwldinalTransactorSession) MintByAdmin(signature []byte) (*types.Transaction, error) {
	return _Owldinal.Contract.MintByAdmin(&_Owldinal.TransactOpts, signature)
}
